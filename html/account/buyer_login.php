        ...
        <main class="login_main">
          <div class ="login_form">
            ...
            <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
              ...
              <div class="buyer_login_message" id='buyer_login_message'> <?php echo $msg;?> </div>
              </div>
              </div>   
            </form>  
          </div>
    ...
    if($brc->num_rows>0){
      while($brarray = $brc->fetch_assoc()){
           if($brarray['Username']==$buyer_username && $brarray['Password']==$buyer_password ){
                   ...
                   header("Location: buyer_login.php?incorrect username or password");
                  //  echo "<script>  document.getElementById('buyer_login_message').innerHTML = 'I have changed!'; </script>";
           }
      }
    }
    }
