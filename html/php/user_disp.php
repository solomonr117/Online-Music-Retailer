...
if(isset($_POST['add_to_bag'])){
   // echo "<script> document.querySelector('.purchase_page_add_to_bag').style.visibility = 'visible'; </script>";
   // echo "<script> document.querySelector('.pp_atb_btn').innerHTML = 'Added to bag';</script>";
